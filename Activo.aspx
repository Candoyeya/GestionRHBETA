<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Activo.aspx.vb" Inherits="Activo" %>
    ...
    <div class="table-responsive col-md-10">
        <form runat="server">
            ...
            <%--Ultima Actualizacion 25/08/2016...--%> 
              <asp:GridView ID="Activo" runat="server" DataSourceID="Conn"
