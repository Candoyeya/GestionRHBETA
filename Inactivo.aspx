<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Inactivo.aspx.vb" Inherits="Inactivo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="row">
        <div class="col-md-12">
           <h2 class="titulos jumbotron">Empleados Inactivos</h2>
        </div>
    </div>
<div class="row">
    <div class="table-responsive col-md-10">
        <form runat="server">
            ...
            <%--Ultima Actualizacion 25/08/2016...--%> 
              <asp:GridView ID="Inactivo" runat="server" DataSourceID="Conn"
